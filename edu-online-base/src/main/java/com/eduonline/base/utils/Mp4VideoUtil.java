package com.eduonline.base.utils;
...
public class Mp4VideoUtil extends VideoUtil {
    ...
    String ffmpeg_path = "E:\\tools\\ffmpeg\\ffmpeg.exe";//ffmpeg的安装位置
    String video_path = "E:\\tools\\minio\\upload\\5.avi";
    String mp4_name = "test1.mp4";
    String mp4folder_path = "E:/tools/minio/upload";
...
//        Process p = builder.start();
        ...
        String video_path = "E:\\tools\\minio\\upload\\5.avi";
        //转换后mp4文件的名称
        String mp4_name = "test11.mp4";
        //转换后mp4文件的路径
        String mp4_path = "E:\\tools\\minio\\upload\\test11.mp4";
        //创建工具类对象
